<?php
 ...
 ini_set('display_errors',1);
    ...
    $request = $bdd->prepare("INSERT INTO USERS (nom,prenom,mail,password,tel,birthday,nb_addr,voie_addr,cp,pays,grade) VALUES (:nom, :prenom, :mail, :psw, :tel, :birthday, :nb_addr,:voie_addr,:cp,:pays,:grade)");
