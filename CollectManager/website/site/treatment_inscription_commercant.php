<?php
 ...
 ini_set('display_errors',1);
    ...
    $request = $bdd->prepare("INSERT INTO COMMERCANT (name,fname,mail,password,tel,nom_entreprise,nb_addr,voie_addr,cp,pays,grade) VALUES (:nom, :prenom, :mail, :psw, :tel, :entreprise, :nb_addr,:voie_addr,:cp,:pays,:grade)");
