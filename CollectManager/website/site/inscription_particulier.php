        ...
        <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
          ...
          <form id="main-contact-form" name="contact-form" method="post" action="treatment_inscription_particulier.php">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  <input type="number" name="number_adress_volunteer" class="form-control" placeholder="Numero de rue" required="required">
                </div>
              </div>

              <div class="col-sm-8">
                <div class="form-group">
                  <input type="text" name="adress_volunteer" class="form-control" placeholder="Votre adresse domicile" required="required">
                </div>
              </div>

              <div class="col-sm-6">
                <div class="form-group">
                  <input type="text" name="postal_code" class="form-control" placeholder="Code Postal" required="required">
                </div>
              </div>
