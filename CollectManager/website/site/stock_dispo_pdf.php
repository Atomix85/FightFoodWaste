...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(90,10,'Historique des stocks disponible',1,0,'C');
    // Line break
    $this->Ln(40);
}
...
$data = $pdf->LoadData('succes.txt');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->FancyTable($header,$data);
$pdf->SetFont('Times','',12);
 
$pdf->Output('historique_des_stocks_disponible.pdf','D');
?>
